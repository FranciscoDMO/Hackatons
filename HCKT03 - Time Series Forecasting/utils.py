...
def prepare_for_prediction(series_, number_of_periods_ahead, num_periods_lagged, num_periods_diffed, weekday, month, hour, rolling, holidays, target):
...
def predict_period_n(series_, model, number_of_periods_ahead, num_periods_lagged, num_periods_diffed, weekday, month, hour, rolling, holidays, target): 
...
def predict_n_periods(series_, n_periods, model, num_periods_lagged, num_periods_diffed=0, weekday=False, month=False, hour=False, rolling=[], holidays=False, target="customers"): 
    predictions = []
...
def build_some_features(df_, target, num_periods_lagged=1, num_periods_diffed=0, weekday=False, month=False, hour=False, rolling=[], holidays=False): 
    """
